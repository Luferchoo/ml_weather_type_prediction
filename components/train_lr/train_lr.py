...
if __name__ == "__main__":
    ...
    # autolog MLflow
    mlflow.sklearn.autolog(log_models=True, registered_model_name=args.register_model or "weather-lr")
    ...
    mlflow.sklearn.log_model(sk_model=model, artifact_path="logistic_regression_model", registered_model_name=args.register_model if args.register_model else None)
